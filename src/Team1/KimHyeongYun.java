		...
		while(run) {
			...
			if(selectNo == 1) { // 1을 읽었을 경우		
				...
				for(int i = 0; i < sentenceNum; i++) {
					...
					System.out.println(boardArray[i][0] + "         " + boardArray[i][1] + "                   " + boardArray[i][2] + "                     " + boardArray[i][3] + "        " + readNum[i] );
				}
				...
				System.out.println("번호: "  + boardArray[choiceNum][0]);	
				System.out.println("제목: "  + boardArray[choiceNum][1]);
				System.out.println("내용: "  + boardArray[choiceNum][2]);
				System.out.println("글쓴이: "  + boardArray[choiceNum][3]);
				
				readNum[choiceNum] = Integer.parseInt(boardArray[choiceNum][4]);
				
				readNum[choiceNum]++;
				
				
				System.out.println("조회수: " + readNum[choiceNum]);
